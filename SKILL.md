...
description: >
  ...
  communities for real user frustrations and Hacker News for technology-forward discussions.
  ...
  startup research, or any request to "find beauty ideas from Reddit/HN". Also trigger for
